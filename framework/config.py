...
DEFAULT_MIN_DEPOSIT_CKB = 100 * 100000000
# Legacy（pre-V1）承诺锁比 V1 正好少占 1 CKB，预留与出资口径不再散落魔法数字 99。
DEFAULT_MIN_LEDGER_DEPOSIT_CKB = 99 * 100000000
DEFAULT_MIN_DEPOSIT_UDT = 181 * 100000000
DEFAULT_MIN_LEDGER_DEPOSIT_UDT = 180 * 100000000
