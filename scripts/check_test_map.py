...
CODE_DIR_NAMES = {"tests", "test_cases", "benchmarks", "targets"}
CODE_SUFFIXES = {
    ".c",
    ".cc",
    ".cpp",
...
SKIP_ROOTS = {"download", "fiber", "fiber-wasm-demo", ".worktrees"}
...
def print_human(report: dict[str, object]) -> None:
    ...
    print(
        f"cases with multiple code mappings: {', '.join(multiple) if multiple else 'none'}"
    )
