...
class TestTlcFeeProportionalMillionths(FiberTest):
    ...
    def test_max(self):
        ...
        self.fiber1.get_client().update_channel(
            {
                "channel_id": channels["channels"][0]["channel_id"],
                # "enabled": False,
                "tlc_fee_proportional_millionths": hex(340282366920938463),
            }
        )
        time.sleep(3)
        ...
        assert graph_channels["channels"][0]["update_info_of_node2"]["fee_rate"] == hex(
            340282366920938463
        )
        assert graph_channels["channels"][0]["update_info_of_node1"]["fee_rate"] == hex(
            340282366920938463
        )
