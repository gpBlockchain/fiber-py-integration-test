...
class TestGraphChannels(FiberTest):
    ...
    def test_channel_info_check(self):
        ...
        # capacity
        assert node1_channels["channels"][0]["capacity"] == hex(100 * 100000000)
        assert node2_channels["channels"][0]["capacity"] == hex(100 * 100000000)
        assert node3_channels["channels"][0]["capacity"] == hex(100 * 100000000)
