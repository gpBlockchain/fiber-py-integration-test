...
class MutilToOneTest(FiberTest):
    ...
    def test_mutil_to_one(self):
        n = 5
        for i in range(n):
            self.start_new_fiber(self.generate_account(10000,self.fiber1.account_private,10000*100000000))
        self.faucet(self.fiber1.account_private,0,self.fiber1.account_private,10000*100000000)
        self.open_channel(self.fiber1,self.fiber2,1000*100000000,0,0,0,self.get_account_udt_script(self.fiber1.account_private))
        for i in range(n):
            self.open_channel(self.new_fibers[i],self.fiber1,1000*100000000,0,0,0,self.get_account_udt_script(self.fiber1.account_private))
