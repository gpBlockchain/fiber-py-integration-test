...
class Test1:
    ...
    def test_open_channel(self):
        ...
        wait_for_channel_state(
            self.cryptapeFiber2, self.cryptapeFiber1.get_peer_id(), "CHANNEL_READY", 120
        )
        send_payment(
            self.cryptapeFiber2, self.cryptapeFiber1, send_amount, None, 20 * 60
        )

    def test_shutdown111(self):
        self.cryptapeFiber1.shutdown_channel(
            {
                "channel_id": "0xfb27dc9ebc391440afe5e25cd4dc25e302b6fbb089397eda07decdb04db14b9e",
                "close_script": {
                    "code_hash": "0x9bd7e06f3ecf4be0f2fcd2188b23f1b9fcc88e5d4b65a8637b17723bbda3cce8",
                    "hash_type": "type",
                    "args": "0xc8b73fbc10cb62988c6d1d5f02850deab1e75dcb",
                },
                "fee_rate": "0x3FC",
            }
        )
